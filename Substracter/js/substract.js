...
function drawSubstract(){
  ...
  while (dataIdx < baseData.data.length) {
      ...
      alpha =  baseData.data[dataIdx+3] - substracterData.data[dataIdx+3]; //el canal alpha (transparencias) = totalmente opaco
...
/*
      ...
      /*finalData.data[dataIdx] = baseData.data[dataIdx]; //Red
      finalData.data[dataIdx + 1] = baseData.data[dataIdx + 1]; //Green
      finalData.data[dataIdx + 2] = 0;//baseData.data[dataIdx + 2]; //Blue*/
